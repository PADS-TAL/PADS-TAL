    ...
    def forward(
        ...
        **kwargs
        ...
        for i, layer in enumerate(self.layers):
            ...
            x = checkpoint(layer, x, context, rotary_pos_emb = rotary_pos_emb, global_cond=global_cond, time_step=time_step, **kwargs)
